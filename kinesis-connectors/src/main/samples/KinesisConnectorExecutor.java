...
public abstract class KinesisConnectorExecutor<T, U> extends KinesisConnectorExecutorBase<T, U> {
    ...
    private static List<String> getKinesisMessageModelFields() {
        ...
        fields.add("DeviceID varchar(100) not null distkey sortkey");
        fields.add("DeviceName varchar(100)");
        fields.add("AmbientTemp varchar(30)");
        fields.add("GyroX varchar(30)");
        fields.add("GyroY varchar(30)");
        fields.add("GyroZ varchar(30)");
        fields.add("Humidity varchar(30)");
        fields.add("IRTemp varchar(30)");
        fields.add("Lux varchar(30)");
        fields.add("MagX varchar(30)");
        fields.add("MagY varchar(30)");
        fields.add("MagZ varchar(30)");
        fields.add("WhenCreated varchar(50)");
        fields.add("time varchar(50)");
